...
{
  "gitBranch" : "main",
  "gitUrl" : "https://github.com/ydaoqi/spring-sensors-rabbit.git",
  "projectName" : "spring-sensors-rabbit",
  "publisherRepository" : "index.docker.io/dyangdockerid/spring-sensors-publisher",
...
┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [https://github.com/tanzu-end-to-end/spring-sensors.git->https://github.com/y...(truncated), main->main]
...
┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [dev.local/spring-sensors-publisher->index.docker.io/dyan...(truncated)]
